...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "saadbinmahbub-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/saadhome"
  #   chef.validation_client_name = "saadhome-validator"
  #   chef.validation_key_path = ".chef/saadhome-validator.pem"
  # end
end
